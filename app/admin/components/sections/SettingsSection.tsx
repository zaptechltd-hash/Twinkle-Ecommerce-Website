...
//   return (
//     <div
//       className={`bg-white border border-[#e8e5df] rounded-xl p-5 ${className}`}
//     >
//       {children}
//     </div>
//   );
...
//             enabled ? "translate-x-[-16px]" : "translate-x-0.4"
//           }`}
//         />
//       </button>
//     </div>
...
// function PaymentSettings({ data, onChange, disabled }: {
//   data: typeof DEFAULT_DYNAMIC;
//   onChange: (key: keyof typeof DEFAULT_DYNAMIC, val: any) => void;
//   disabled: boolean;
// }) {
//   return (
...
//   const [dynamic, setDynamic] = useState(DEFAULT_DYNAMIC);
...
//   function updateDynamic(key: keyof typeof DEFAULT_DYNAMIC, val: any) {
...
//       // bankEnabled: dynamic.bankEnabled,
//       // onlineEnabled: dynamic.onlineEnabled,
...
//   // ─── Real S3 upload helper ───────────────────────────────────────────────────
// async function uploadFileToS3(file, authToken) {
...
//   // 2. PUT the file bytes directly to S3 (no server involved)
...
//   return publicUrl; // This is the URL you save to the DB
// }

// // ─── Multi-Image Upload Panel (updated) ─────────────────────────────────────
// function ImageGalleryUpload({ images, onChange, authToken }) {
...
//     setUploading(true);
//     try {
//       // Upload all picked files in parallel
//       const uploaded = await Promise.all(
//         files.map((file) => uploadFileToS3(file, authToken))
//       );
...
//         >
//           {uploading ? (
//             <span className="text-[9px] text-[#b4b2a9] text-center px-1">Uploading…</span>
//           ) : (
//             <>
