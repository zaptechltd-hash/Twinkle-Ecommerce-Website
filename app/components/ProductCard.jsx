...
//             fill={wishlisted ? "#1c1917" : "none"} stroke="#1c1917" strokeWidth="1.6">
...
//         >
//           <span className="text-[10px] tracking-[0.25em] text-stone-600 uppercase">Quick View</span>
//         </div>
//       </div>
...
//           {/* <span
//             className="w-3 h-3 rounded-full flex-shrink-0 mt-0.5 ring-1 ring-stone-200"
//             style={{ backgroundColor: product.colorHex }}
//             title={product.color}
//           /> */}
//         </div>
//         <p className="text-[11px] tracking-[0.1em] text-stone-400 mt-0.5">PKR {product.price.toLocaleString()}</p>
//       </div>
//     </div>
//   );
// }
...
export default function ProductCard({ product, onWishlistToggle, wishlisted, onClick }) {
  ...
  const firstImage = product.variants?.find((v) => v.image)?.image ?? product.images?.[0];
